...
// Enums
export const lessonDifficultyEnum = pgEnum('lesson_difficulty', ['beginner', 'intermediate', 'advanced', 'expert']);
export const exerciseTypeEnum = pgEnum('exercise_type', ['words', 'sentences', 'paragraphs', 'code', 'custom']);
