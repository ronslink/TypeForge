...
<svelte:head>
  ...
  {#if bestSession.wpm > 0}
    ...
    <meta property="og:image" content={`https://www.typingscholar.com/api/og/certificate?wpm=${bestSession.wpm}&acc=${bestSession.accuracy}`} />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:image" content={`https://www.typingscholar.com/api/og/certificate?wpm=${bestSession.wpm}&acc=${bestSession.accuracy}`} />
  {/if}
</svelte:head>
...
{:else}
  ...
  <div class="fixed top-6 right-6 flex gap-4 print:hidden z-50">
    ...
    <a 
      href={`https://twitter.com/intent/tweet?text=I%20just%20hit%20${bestSession.wpm}%20WPM%20with%20${bestSession.accuracy}%25%20accuracy%20on%20TypingScholar!%0A%0Ahttps://www.typingscholar.com/certificate`}
      target="_blank"
